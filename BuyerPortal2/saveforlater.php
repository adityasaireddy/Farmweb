...
<div class=" flex-row-reverse left ">
    ...
    <a class="float-left" href="bhome.php">
        <img src="agrow.png" class="float-left mr-5 ml-0 " alt="Farmweb" style="height:50px;">
    </a>
</div>
...
<a class="float-left" href="bhome.php">
    <img src="agrow.png" class="float-left mr-2 moblogo" alt="Farmweb" style="height:50px;">
</a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="#">Farmweb Corporation</a></u> is a Multitrading Company for farmers ang traders</p>
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Farmweb</a></p>
                </div>
                </hr>
            </div>
        </div>
